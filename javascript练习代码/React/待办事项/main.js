...
function MyApp() {
  const [currentTodoItem,setCurrentTodoTtem]=React.useState("");
  ...
  function handleDeleteTodo(id){
    const deletedTodoList=todoList.filter((todo)=>todo!==id);
  ...
  return (
    <main>
      ...
      <input type="text" placeholder="Add item into as todo"
       ...
       onChange={(event)=>
        setCurrentTodoTtem(event.target.value)}
       />
